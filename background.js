    ...
    filter.onstop = event => {    // データをすべて受け取り終わったら
        ...
        if (head != null) {
            ...
            const blackcollection = [
		        "外貨預金","投資信託","信用金庫","住宅ローン","かりる","教育ローン","そなえる","ネットバンク","ためる・ふやす","定期預金","バンキング","個人のお客さま","ニュースリリース","貸金庫","リフォームローン","お知らせ","店舗・ATM","カードローン","フリーローン","マイカーローン","電子公告","口座開設","資料請求","法人のお客さま","手数料一覧","保険募集指針","円預金","利益相反管理方針","終身保険","個人年金保険","お問い合わせ","会社概要","店舗・ATMのご案内","保険商品","確定拠出年金","勧誘方針","English","資金調達","経営方針","総合口座","クレジットカード","会社情報","ログイン","便利なサービス","便利に使う","その他のサービス","株主総会","口座をひらく","各種手数料","損害保険","トップメッセージ","外貨両替","IRカレンダー","火災保険","ローン","個人情報保護宣言","各種お手続き","預金保険制度について","普通預金","規定一覧","各種サービス","株主・投資家の皆さま","決算短信","便利につかう","貯蓄預金","公共債","生命保険","外国送金","デビットカード","セキュリティ","手数料","お問合せ","金利一覧","金利情報","キャンペーン一覧","金融商品勧誘方針","プライバシーポリシー","役員一覧","ニュースリリース一覧","ディスクロージャー誌","リンク集","IRニュース","預金金利","採用のご案内","個人投資家の皆さまへ","経営理念","自動送金サービス","新着情報","財務ハイライト","スマホ決済サービス","国債","資産運用","セカンドライフ","スピード王MAX","ホーム","中期経営計画","銀行","ATM","ディスクロージャー","学資保険"
	        ];
